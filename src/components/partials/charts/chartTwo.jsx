      ...
      <div className="shadow-default rounded-2xl bg-white px-5 pb-11 pt-5 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          ...
          <div className="relative h-fit">
            <button onClick={()=> setChartDetails(!chartDetails)}> 
              <svg
            ...
            <div className={`${chartDetails ? "block" : "hidden"} absolute right-0 top-full z-40 w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark`}>
